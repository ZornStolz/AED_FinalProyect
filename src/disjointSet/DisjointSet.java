...
/**
 * modela una coleccion de conjuntos disyuntos
 * @author JuanDavid
 *
 * @param <E> elemento de un conjunto
 */
public class DisjointSet <E> {

	/*
	 * coleccion de conjuntos disyuntos
	 */
	...
	public ArrayList<E> getSet(E elemento) {
		...
		E representante = findSet(elemento); // busco el representate del conjunto al que pertenece el elemento
